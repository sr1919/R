...
#
#	The flexible function plot.depth enables you to plot depth profiles 
#	from sediment cores or to plot pollen diagrams with many column datas. 
#	The first column should contain the depth data.
#
#	It requires the Hmisc package to enable minor ticks at axes. 
#	Main feature of plot.depth are
#
#	- types: lines, points, polygon, histograms (=bolder lines), histogram-lines
#	- column names are tiltet on the top of each plot and can also adjusted and 
#		rotated as you want
#	- additional graphics can also be added as expression nested with list()
#	- point size and -color ore histogram-line-color can also be set idividually
#	- scale up few data in polygon plotr
#
#	Suggestion to improve this function will be always welcome: andreas-plank@gmx.de 
# (Andreas Plank) 2008/12/05
#
#===============================================================================
#
# Arguments:
